...
public class UserProfileController {
    ...
    @PostMapping
    public UserProfileDTO saveProfile(Authentication auth, @RequestBody UserProfileDTO dto) {
        return userProfileService.saveProfile(auth.getName(), dto);
    }

    @PatchMapping("/body")
    public UserProfileDTO updateBody(Authentication auth,@RequestBody Map<String, Double> body) {
